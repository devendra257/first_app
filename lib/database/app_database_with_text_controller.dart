...
class AppDataBaseSecond {
  AppDataBaseSecond._();
  static final AppDataBaseSecond db = AppDataBaseSecond._();
  ...
  Future<bool> addNote(String title, String desc) async {
    ...
    int rowsEffect = await db
        .insert(NOTE_TABLE, {NOTE_COLUMN_TITLE: title, NOTE_COLUMN_DESC: desc});
